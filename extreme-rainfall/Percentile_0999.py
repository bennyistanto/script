...
n_999 = numpy.nanpercentile(a_m, 99.9, axis=0)

# Based on lower-left and pixel size global CHIRPS data
arcpy.NumPyArrayToRaster(n_999,
					arcpy.Point(-180.0000000,-50.0000015),
					0.050000000745058,
					0.050000000745058,
					0)

out = arcpy.NumPyArrayToRaster(n_999, arcpy.Point(-180.0000000,-50.0000015), x_cell_size=0.050000000745058, y_cell_size=0.050000000745058, value_to_nodata=0)
out_name = "\\".join([outfolder, "n_999.tif"])
out.save(out_name)