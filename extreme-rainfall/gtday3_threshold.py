...
#----------------------------------Set Input Folder-------------------------------------#
returnperiod_folder = 'Z:\\Temp\\CHIRPS\\Extreme\\Threshold\\Pct3'
rainfall_folder = 'Z:\\Temp\\CHIRPS\\Extreme\\Day3\\2011'
output_output_folder = 'Z:\\Temp\\CHIRPS\\Extreme\\Day3_output\\2011_output'

#-----------------------Set Magnitude for every threshold raster------------------------#
set_magnitude = {'idn_cli_3days_precipthreshold_q0800_5yr_chirps_wfp.tif': 1,
                 'idn_cli_3days_precipthreshold_q0900_10yr_chirps_wfp.tif': 2,
                 'idn_cli_3days_precipthreshold_q0960_25yr_chirps_wfp.tif': 3,
                 'idn_cli_3days_precipthreshold_q0980_50yr_chirps_wfp.tif': 4}
