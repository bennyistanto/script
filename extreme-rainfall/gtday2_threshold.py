...
#----------------------------------Set Input Folder-------------------------------------#
returnperiod_folder = 'Z:\\Temp\\CHIRPS\\Extreme\\Threshold\\Pct2'
rainfall_folder = 'Z:\\Temp\\CHIRPS\\Extreme\\Day2\\2011'
output_output_folder = 'Z:\\Temp\\CHIRPS\\Extreme\\Day2_output\\2011_output'

#-----------------------Set Magnitude for every threshold raster------------------------#
set_magnitude = {'idn_cli_2days_precipthreshold_q0800_5yr_chirps_wfp.tif': 1,
                 'idn_cli_2days_precipthreshold_q0900_10yr_chirps_wfp.tif': 2,
                 'idn_cli_2days_precipthreshold_q0960_25yr_chirps_wfp.tif': 3,
                 'idn_cli_2days_precipthreshold_q0980_50yr_chirps_wfp.tif': 4}
...
def extract_per_returnperiods(rainfallfolder, returnperiodfile, outputfolder):
    for days2_file in os.listdir(rainfallfolder):
        if days2_file.endswith(".tif") or days2_file.endswith(".tiff"):
            datename = days2_file.split('.')[2]
            ...
            if arcpy.Exists(os.path.join(outputfolder, output_filename)):
                ...
                inRaster1 = Raster(os.path.join(rainfall_folder,days2_file))
