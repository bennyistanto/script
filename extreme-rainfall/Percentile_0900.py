...
n_90 = numpy.nanpercentile(a_m, 90., axis=0)
...
out = arcpy.NumPyArrayToRaster(n_90, arcpy.Point(-180.0000000,-50.0000015), x_cell_size=0.050000000745058, y_cell_size=0.050000000745058, value_to_nodata=0)
out_name = "\\".join([outfolder, "n_90.tif"])
out.save(out_name)