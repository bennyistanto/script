...
input_folder = "X:\\Temp\\imerg\\products\\cdd\\cdd_1mm"
output_folder = "X:\\Temp\\imerg\\products\\cdd\\monthly_1mm"
...
for file_annual in os.listdir(input_folder):
    if file_annual.endswith(".tif") or file_annual.endswith(".tiff"):
        ...
        groupkey = file_annual[i_imerg + 6:i_imerg+6+6]
        fpath = os.path.join(input_folder, file_annual)
...
for groupkey, files in groups.items():
    ...
    # Output filename
    newfilename_annual_stat1 = 'wld_cli_cdd_1mm_monthly_max_imerg_{0}{1}'.format(groupkey, ext)
