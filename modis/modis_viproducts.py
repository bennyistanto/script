...
ratioanom_folder = "X:\\Temp\\modis\\{}\\gee\\05_ratioanom\\temp".format(iso3)
diffanom_folder = "X:\\Temp\\modis\\{}\\gee\\06_diffanom\\temp".format(iso3)
stdanom_folder = "X:\\Temp\\modis\\{}\\gee\\07_stdanom\\temp".format(iso3)
vci_folder = "X:\\Temp\\modis\\{}\\gee\\08_vci\\temp".format(iso3)
...
def derivative_vi(input_folder, stats_folder, ratioanom_folder, diffanom_folder, stdanom_folder, vci_folder):
	...
	for raster in os.listdir(input_folder):
		...
		if raster.endswith(".tif") or raster.endswith(".tiff"):
			...
			avg_raster = arcpy.Raster(min_raster)
